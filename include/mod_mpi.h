...
/* 
   take a 32-bit integer value and mask out (set to 0) 
   all bits except the 3 most significant ones 
   
   we do this in two steps:
   - determine position of the highest bit set (0..31)
   - look up and apply bitmask to zero-out the 
     value based on this position 
*/
